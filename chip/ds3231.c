...
int t_ds3231_SetAlarm1(int argc, char **argv)
{
    uint8_t ret = 0;
    uint8_t dy_dt = 0;
    uint8_t a1m4 = 0, a1m3 = 0, a1m2 = 0, a1m1 = 0;
    uint8_t Alarm_Rate = 0;
