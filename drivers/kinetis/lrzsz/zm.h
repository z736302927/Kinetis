...
void zm_set_header_payload (zm_t *zm, u32 val);
void zm_set_header_payload_bytes(zm_t *zm, u8 x0, u8 x1, u8 x2, u8 x3);
...
int zm_get_header (zm_t *zm, u32 *payload);
void zm_ackbibi (zm_t *zm);
void zm_saybibi(zm_t *zm);
int zm_do_crc_check(zm_t *zm, FIL *f, size_t remote_bytes, size_t check_bytes);
