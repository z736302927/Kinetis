...
/**
  * @brief  Initializes the switch struct switch_device.
...
/**
  * @brief  Deinitializes the switch struct switch_device.
  * @param  switch: the switch switch strcut.
  * @retval None
  */
void switch_drop(u32 unique_id)
{
	struct switch_device *_switch, *tmp;
...
/**
  ...
  * @retval switch event.
  */
static enum switch_event get_switch_event(struct switch_device *_switch)
{
...
/**
  ...
  * @retval None
  */
static void switch_handler(struct switch_device *_switch)
{
...
static void switch_test_callback(void *_switch)
{
	...
	switch_event_val = get_switch_event((struct switch_device *)_switch);
