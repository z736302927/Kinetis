...
typedef struct {
    ...
    u16        max_timeout;   // Maximum timeout
    u8         lmt_period;    // Repeat execution for a limited time interval
} NB_CmdInfo;
...
typedef void (*NB_RxCallback)(char *, u16);
typedef void (*NB_SerilPort_Open)(NB_RxCallback, u32);
typedef void (*NB_SerilPort_Send)(u8 *, u16);
...
typedef void (*NB_Timer_Start)(u32);
