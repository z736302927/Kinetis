#include "peripheral/bsp_touchscreen.h"
...
uint16_t TP_State = 0;
uint16_t TP_X_Coordinates[10],TP_Y_Coordinates[10];
extern const uint16_t GT9271_TPX_TBL[10];
...
//          {
            TP_Y_Coordinates[i] = ((uint16_t)buf[3] << 8) + buf[2];
            TP_X_Coordinates[i] = ((uint16_t)buf[1] << 8) + buf[0];
//          }
//          else
//          {
//            TP_X_Coordinates[i] = 800-(((uint16_t)buf[3] << 8) + buf[2]);
//            TP_Y_Coordinates[i] = ((uint16_t)buf[1] << 8) + buf[0];
//          }  
